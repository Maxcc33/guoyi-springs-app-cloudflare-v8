  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({ name: '', phone: '', email: '', message: '' }); // 清空表单
      } else {
        toast({
            ...
            <div className="space-y-8">
              <div>
                ...
                <Card className="border-none shadow-lg overflow-hidden">
                  <div className="aspect-video bg-gray-100">
                    <iframe
                      src="https://restapi.amap.com/v3/staticmap?location=121.40939,28.51799&zoom=15&size=750*400&markers=mid,,A:121.40939,28.51799&key=22cb293952632b6d56f946abf01f8d73"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen
              ...
              <Card className="border-none shadow-lg">
                <CardContent className="p-8 text-center">
                  ...
                  <img
                    src="/images/微信图片_20260330135214_4_10.jpg"
